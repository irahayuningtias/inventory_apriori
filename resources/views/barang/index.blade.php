                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h7 class="m-0 font-weight-normal"
                            ><a href="product">Barang</a></h7
                        ><br /><br />

                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Barang</h1>
                        <p class="mb-3">
                            Fitur ini berisikan master data barang
                        </p>
                        <br />
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 col">
                                ...
                                >
                                    <h5
                                        class="m-0 font-weight-bold text-primary text-center"
                                    >
                                        Data Barang
                                    </h5>
                                    <a
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table
                                        class="table table-striped table-bordered mt-3 mb-3"
                                        id="dataTable"
                                        style="width: 100%"
                                    >
                                        <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form
                                                        action="{{ route('product.destroy', $Product->id_product) }}"
                                                        method="POST"
                                                    >
                                                        <a
                                                            href="{{ route('product.show', $Product->id_product) }}"
                                                        ...
                                                        <a
                                                            href="{{ route('product.edit', $Product->id_product) }}"
