        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h7 class="m-0 font-weight-normal ">Persediaan / <a href="outcoming_product">Barang Keluar</a></h7><br><br>

                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Barang Keluar</h1>
                        <p class="mb-3">Fitur ini berisikan data barang yang keluar dari gudang</p><br>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 col">
                            <div class="d-flex justify-content-between align-item-center">
                                <h5 class="m-0 font-weight-bold text-primary text-center">Data Barang Keluar</h5>
                                <div class="d-flex">
                                    <a href="{{ route('outcoming_product.create') }}" class="btn btn-primary btn-icon-split mr-2">
                                    ...
                                    <a href="{{ route('outcoming_product.export') }}" class="btn btn-info btn-icon-split">
                                        <span class="icon text-white-50">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-striped table-bordered mt-3 mb-3" id="dataTable" style="width: 100%">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $op->outcoming_code }}</td>
                                            <td>{{ $op->formatted_date }}</td>
                                                <td>
                                                    @foreach($op->details as $details)
                                            ...
                                            <td>
                                                <form action="{{ route('outcoming_product.destroy', $op->id) }}" method="POST">
                                                    <a href="{{ route('outcoming_product.show', $op->id) }}" class="btn btn-info btn-circle btn-sm">
                                                            <i class="fas fa-info-circle"></i>
                                                    </a>
                                                    <a href="{{ route('outcoming_product.edit', $op->id) }}" class="btn btn-warning btn-circle btn-sm">
        ...
        <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="import-form" method="POST" enctype="multipart/form-data" action="{{ route('outcoming_product.import') }}">
                            @csrf
                            <div class="form-group">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            $('#deleteModal').on('show.bs.modal', function (event) {
                ...
                var outcomingId = button.data('outcoming-id'); // Extract info from data-* attributes
                var modal = $(this);
                var action = "{{ route('outcoming_product.destroy', ':id') }}".replace(':id', outcomingId);
