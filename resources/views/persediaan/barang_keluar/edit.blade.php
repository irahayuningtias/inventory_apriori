...
<head>
    ...
    <title>IMS - Edit Barang Keluar</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h7 class="m-0 font-weight-normal">Persediaan / Barang Keluar / <a href="{{ route('outcoming_product.edit', $outcoming_product->id )}}">Edit Barang Keluar</a></h7><br><br>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 col">
                            <h5 class="m-0 font-weight-bold text-primary">Form Edit Barang Keluar</h5>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('outcoming_product.update', ['outcoming_product' => $outcoming_product->id]) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="outcoming_code" name="outcoming_code" value="{{ $outcoming_product->outcoming_code }}">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="date" class="form-control" id="outcoming_date" name="outcoming_date" value="{{ $outcoming_product->outcoming_date }}">
                                    ...
                                    <table id="product_table">
                                        ...
                                        <tbody>
                                            @foreach($outcoming_product->details as $index => $detail)
                                            <tr class="item">
                                                <td>
