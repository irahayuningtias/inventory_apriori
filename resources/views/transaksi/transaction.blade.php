                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 col">
                            <div class="d-flex justify-content-between align-item-center">
                                ...
                                <div class="d-flex">
                                    <a href="{{ route('transaction.create') }}" class="btn btn-primary btn-icon-split mr-2">
                                    ...
                                    <a href="{{ route('transaction.export') }}" class="btn btn-info btn-icon-split">
                                        <span class="icon text-white-50">
        ...
        <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="import-form" method="POST" enctype="multipart/form-data" action="{{ route('transaction.import') }}">
                            @csrf
                            <div class="form-group">
