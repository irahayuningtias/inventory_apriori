        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h7 class="m-0 font-weight-normal">Master Data / Kategori / <a href="{{ route('category.edit', ['category' => $Category->id_category]) }}">Edit Kategori</a></h7><br><br>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 col">
                            <h5 class="m-0 font-weight-bold text-primary">Form Edit Kategori Barang</h5>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="category_name" class="form-control" name="category_name" value="{{ $Category->category_name }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
