...
<head>
    ...
    <title>IMS - Detail Kategori Barang</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h7 class="m-0 font-weight-normal">Master Data / Kategori / <a href="{{ route('category.show', ['category' => $Category->id_category]) }}">Detail Kategori</a></h7><br><br>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 col">
                            <h5 class="m-0 font-weight-bold text-primary">Detail Kategori Barang</h5>
                        </div>
                        <div class="card-body">
