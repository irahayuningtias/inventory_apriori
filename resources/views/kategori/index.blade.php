            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <h7 class="m-0 font-weight-normal">Master Data / <a href="category">Kategori</a></h7><br /><br />

                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Kategori</h1>
                        <p class="mb-3">
                            Fitur ini berisikan master data kategori barang
                        </p>
                        <br />
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3 col">
                                <div class="d-flex justify-content-between align-item-center">
                                    ...
                                    <div class="d-flex">
                                        <a href="{{ route('category.create') }}" class="btn btn-primary btn-icon-split mr-2">
                                        ...
                                        <a href="{{ route('category.export') }}" class="btn btn-info btn-icon-split">
                                            <span class="icon text-white-50">
        ...
        <div class="modal fade" id="importModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="import-form" method="POST" enctype="multipart/form-data" action="{{ route('category.import') }}">
                            @csrf
                            <div class="form-group">
