        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h7 class="m-0 font-weight-normal ">Kategori / <a href="{{ route('category.create') }}">Tambah Kategori</a></h7><br><br>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="id_category" class="form-control" name="id_category" placeholder="Masukkan ID Kategori">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-3">
                                            <label for="category" class="form-label font-weight-bold">Kategori</label>
                                            <input type="category" class="form-control" name="category" placeholder="Masukkan kategori barang">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
